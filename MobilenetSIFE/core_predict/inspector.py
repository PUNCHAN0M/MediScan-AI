...
"""
PillInspectorSIFE - Main inspection class with SIFE + vote accumulation.

Single Responsibility:
- Detect pills using YOLO
- Classify anomalies using PatchCore + SIFE
...
from MobilenetSIFE.core_predict.visualizer import draw_pill_results, draw_summary
...
class InspectorConfig:
    """Configuration for PillInspectorSIFE."""
    ...
    # 🔥 Scoring method
    use_detailed_scoring: bool = True  # Use weighted scoring for better sensitivity
...
class PillInspectorSIFE:
    """
    Pill anomaly inspector with SIFE and frame-based vote accumulation.
