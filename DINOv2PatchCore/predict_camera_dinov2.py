...
# CONFIGURATION
# =========================================================
WINDOW_NAME = "DINOv2 Pill Inspector"
CAMERA_INDEX = 0
FRAMES_BEFORE_SUMMARY = config.FRAMES_BEFORE_SUMMARY
SAVE_DIR = Path("./data/inspected")

# Parent classes to compare
COMPARE_CLASSES = [
    "vitaminc",
    # "oval_orange",
    # "oval_white",
