# ResnetPatchCore/core_train/trainer.py
"""
ResNet PatchCore Training Utilities.
...
class ResNetPatchCoreTrainer:
    """Training utilities for ResNet PatchCore."""
    
    def __init__(self, patchcore: ResNetPatchCore):
        """
        Args:
            patchcore: ResNetPatchCore feature extractor instance
        """
